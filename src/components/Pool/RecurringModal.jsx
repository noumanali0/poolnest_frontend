    ...
    return (
        <Fragment>
            <div className='container-fluid modals'>
                <Form name="nest-messages" onFinish={onFinish} onFinishFailed={onFinishFailed} validateMessages={validateMessages}>
                    <div className='row'>
                        <div className='col-sm-8'>
                            <h4>Customer Detail</h4>
                            <div className='row myselect'>
                                <div className='col-sm-6'>
                                    <Form.Item name="recurringwork" rules={[{ required: true, message: "Reccuring Work is required" }]}       >
                                ...
                                <div className='col-sm-6'>
                                    <Form.Item name='servicelocation' rules={[{ required: true, },]} >
                        ...
                        <div className='col-sm-4'>
                            ...
                            <Form.Item name='tech' rules={[{ required: true, },]} initialValue="Alisher">
                                <Input placeholder="Tech" disabled />
                            </Form.Item>

                            <Form.Item name='dayofweek' rules={[{ required: true, },]} initialValue="Monday">
                                <Input placeholder="Day Of Week" disabled />
                            </Form.Item>

                            <Form.Item name='frequency' rules={[{ required: true, },]} initialValue="20 feet">
                                <Input placeholder="Frequency" disabled />
                            </Form.Item>

                            <Form.Item name='starton' rules={[{ required: true, },]} initialValue="Start On">
                                <Input placeholder="Start On" disabled />
                            </Form.Item>

                            <Form.Item name='startafter' rules={[{ required: true, },]} initialValue="Start After">
                    ...
                    <div className='row'>
                        ...
                        <div className='col-sm-3'>
                            <Form.Item name="tech" rules={[{ required: true, message: "Customer Type is required" }]}       >
                        ...
                        <div className='col-sm-3'>
                            <Form.Item name="dayofweek" rules={[{ required: true, message: "Customer Type is required" }]}       >
                        ...
                        <div className='col-sm-2'>
                            <Form.Item name="frequency" rules={[{ required: true, message: "Customer Type is required" }]}       >
                        ...
                        <div className='col-sm-2'>
                            <Form.Item name="starton" rules={[{ required: true, message: "Customer Type is required" }]}       >
                        ...
                        <div className='col-sm-2'>
                            <Form.Item name="startafter" rules={[{ required: true, message: "Customer Type is required" }]}       >
